...
<body background="${pageContext.request.contextPath}/slike/slika8.jpg">
	...
	<div class="divUnos">	
		...
		<form action = "/NaocareShop/administrator/saveBrend" method = "post">
	
			<table class="tabelica">
			
				<tr>
					<td> Ime brenda: </td>
					<td> <input type = "text" name = "imeBrenda">
				</tr>
				<tr>
					<td></td>
	...
	<c:if test="${!empty brend}">
		<p class="paragraf"> <b> ${porukaBrend} </b> </p>
	</c:if>	
	<br><br>
